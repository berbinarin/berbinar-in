...
<section class="home md:mt-0 mt-15" id="home">
    <div class="home__container bd-container flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start">
        <div class="home__img w-full md:w-fit" data-aos="fade-left" data-aos-duration="1500">
            <img src="https://i.postimg.cc/8P5wXrXS/ilustrasi-logo-berbinar.png" alt="Logo Berbinar Insightful Indonesia" title="Logo Berbinar Insightful Indonesia" class="md:w-[500px]" style="width: 600px;">
        </div>
...
<!--========== PRODUK BERBINAR ==========-->
<section class="accessory section bd-container" id="accessory" style="margin-top: -5rem;">
    <h2 class="section-title font-semibold">Produk Berbinar Insightful <br> Indonesia Lainnya</h2>
