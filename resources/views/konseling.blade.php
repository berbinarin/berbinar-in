    ...
    <div class="max-w-7xl mx-auto">
        <div class="home__data flex flex-col items-center">
            <div class="mb-12">
                ...
                <div class="share__img flex-2 mx-auto w-full flex items-center justify-center -mt-10" style="margin-top: -5rem;">
                    <img src="https://i.postimg.cc/x1DmqBKp/konseling.png" alt="" class="w-[30rem]">
                </div>
            </div>
            
            <p class="home__description md:w-[70%] w-[92%] text-center" style="margin-top: -8rem;">
