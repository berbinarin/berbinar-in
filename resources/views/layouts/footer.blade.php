<footer class="footer section">
    <div class="footer__container bd-container bd-grid">
        <div class="footer__content">
            <h3 class="footer__title font-semibold">
                <a href="{{ route('home') }}" class="footer__logo">PT Berbinar Insightful Indonesia</a>
            </h3>
        ...
        <div class="footer__content">
            ...
            <div class="flex flex-row gap-1 items-center">
                ...
                <a href="https://www.tiktok.com/@berbinar.in?_t=8zrlrhuqnha&_r=1" class="footer__social">
    ...
    <p class="footer__copy">&#169; 2023 PT Berbinar Insightful Indonesia. All right reserved</p>
</footer>