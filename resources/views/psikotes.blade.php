...
@section('content')
<!--========== HOME ==========-->
<section class="w-full mb-[6rem]" style="margin-top: 18vh;" id="home">
    <div class="max-w-7xl mx-auto">
        <div class="home__data flex flex-col items-center">
            <div class="mb-12">
                <h1 class="about__title text-center">Asesmen Psikologi</h1>
                <div class="share__img flex-2 mx-auto w-full flex items-center justify-center" style="margin-top: -3rem;">
                    <img src="https://i.postimg.cc/hvY59KSd/asesmen-psikologi.png" alt="" class="md:w-[30rem] w-[20rem]" style="width: 25rem;">
                </div>
            </div>
            
            <p class="home__description md:w-[70%] w-[92%] text-center" style="margin-top: -3rem;">
    ...
    <div class="share__container bd-grid">
        <div class="share__data">
            ...
            <div class="share__img md:hidden block my-6 mx-auto">
                <img src="https://i.postimg.cc/Wp7fHV2M/Assessment-Psikologi-Individu.png" alt="" class="md:w-[25rem] w-[20rem]">
            </div>
...
<section class="share section bd-container mb-16" id="share">
    <div class="share__container bd-grid">
        <div class="share__img md:block hidden" style="order: 2;">
            <img src="https://i.postimg.cc/9Fnb6Fsq/Assessment-Psikologi-Perusahaan.png" alt="" class="md:w-[25rem] w-[20rem]">
        </div>
