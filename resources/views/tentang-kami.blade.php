    ...
    <div class="max-w-5xl mx-auto flex gap-16 md:flex-row flex-col-reverse">
        <div class="share__data flex-1 md:px-0 px-5">
            ...
            <div class="share__img flex-2 mx-auto md:hidden block">
                <img src="https://i.postimg.cc/Cxhf0whY/visi-misi.png" alt="">
            </div>
...
<section class="accessory section bd-container flex flex-col items-center" id="accessory">
    ...
    <div class="share__img my-10">
        <h2 class="section-title font-[600]">Nilai Berbinar Insightful Indonesia</h2>

        <img src="https://i.postimg.cc/BQ47D1Z0/value.png" class="mb-4 -mt-5" alt="">
    </div>
    ...
    <div class="accessory__container bd-grid">
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            ...
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Honest</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            ...
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Empathetic</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center pb-4">
            <!-- <img src="assets/img/accessory2.png" alt="" class="accessory__img"> -->
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Innovative</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            ...
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Learn and be Curious</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            ...
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Impactful</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            <!-- <img src="assets/img/accessory4.png" alt="" class="accessory__img"> -->
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Initiative</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            <!-- <img src="assets/img/accessory4.png" alt="" class="accessory__img"> -->
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Collaborative</h3>
        ...
        <div class="accessory__content flex flex-col gap-3 justify-center py-4">
            <!-- <img src="assets/img/accessory4.png" alt="" class="accessory__img"> -->
            <h3 class="accessory__title w-[10rem] font-[600] mt-3">Customer Oriented</h3>
