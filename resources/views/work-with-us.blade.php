...
<section class="flex bg-white w-full h-screen relative items-center justify-center">
    <div class="flex items-center justify-center flex-col -mt-14">
        <img src="https://i.postimg.cc/PJvNB79m/by-dhila-banner-web.png" alt="Work With Us" title="Work With Us" class="w-[35rem]" />

        <h1 class="home__title md:w-full w-[25rem] md:text-[2rem] text-center leading-[120%]">Ayo Kerja Sama Bersama <br>Berbinar Insightful Indonesia</h1>
